...
const ModalFormularioTarea = () => {
    ...
    const handleSubmit = async e => {
       ...
       await submitTarea({id, nombre, descripcion,fechaEntrega, prioridad, proyecto: params.id});
        ...
        //    reseteando modal para cuando se vuelva abrir se abra vacio 
        setId('')
        setNombre('')
        setDescripcion('')
        setFechaEntrega('')
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    >
                                        ...
                                        <input
                                            type='submit'
                                            className='bg-sky-500 hover:bg-sky-800 w-full p-3 text-white uppercase font-bold cursor-pointer 
